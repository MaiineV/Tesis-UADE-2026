...
{
    /// <summary>
    /// Primitivo de movimiento forzado (empuje). La habilidad Empuje del Guerrero (UI,
    /// combos) es un consumidor futuro — acá vive solo la física de grilla: mover N celdas
