...
{
    /// <summary>Contra arte real, construyendo en una carpeta temporal que el teardown borra. Toca el
    /// <c>AssetDatabase</c> porque lo que se verifica es el prefab escrito.</summary>
    [TestFixture]
    public class BossVisualWrapperBuilderTests
    {
        ...
        {
            // El collider se dimensiona asumiendo el arte en el origen del wrapper.
            var art = _wrapper.transform.Find("Art");
        ...
        {
            // PawnPicker resuelve el pick con GetComponentInParent desde el collider.
        ...
        {
            // Se recalculan los bounds sobre una instancia aparte del mismo arte.
        ...
        {
            // Se cablean explícito para no depender del auto-populate de Awake.
        ...
        {
            // Si la barra fuera raycast target, se comería el hover del targeting del pawn.
            var canvas = _wrapper.transform.Find("Canvas");
        ...
        public void BuildWrapper_SkipsMissingProps_WithoutFailingTheBuild()
        {
            ...
            // Un prop que falta degrada, no cancela: el jefe sigue siendo jugable.
        ...
        {
            // Mat_Red lo usan medio casino de enemigos; retintarlo in-place los repinta todos.
            var source = AssetDatabase.LoadAssetAtPath<Material>(SourceMaterialAssetPath);
        ...
        public void BuildWrapper_ReusesOneCloneForAMaterialSharedAcrossRenderers()
        {
            ...
            // Un clon y no uno por slot: si no, se rompe el batching y los clones divergen.
        ...
        public void BuildWrapper_LeavesNonRetintedMaterialsShared()
        {
            ...
            // Clonar todo llenaría el proyecto de copias idénticas al original.
            foreach (var renderer in art.GetComponentsInChildren<Renderer>(true))
            {
                foreach (var material in renderer.sharedMaterials)
                {
        ...
        public void BuildWrapper_RebuildingPreservesThePrefabGuid()
        {
            ...
            // Los EnemyDataSO referencian este prefab por GUID: si cambia, quedan en null.
        ...
        public void BuildWrapper_RebuildingDoesNotDuplicateComponents()
        {
            ...
            // Se reconstruye desde cero, no se parchea el prefab viejo.
        ...
        public void BuildWrapper_DerivesTheBossNameFromTheOutputPath_WhenNotGiven()
        {
            ...
            // "PF_Boss_Derived" → "Derived": el prefijo no aporta al nombre del material.
            Assert.IsNotNull(
