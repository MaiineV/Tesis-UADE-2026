        ...
        Pass
        {
            ...
            half4 Frag(Varyings IN) : SV_Target
            {
                ...
                else
                {
                    ...
                    // _ShapeOpacity: fade de CUALQUIER pixel de forma (borde o relleno)
                    // hacia el BG — antes solo se aplicaba en la rama de relleno, así que
                    // en Detail=Border Only (donde inAnyFill nunca es true) el slider no
                    // tenía ningún efecto. Ahora cubre los 4 Detail Types por igual.
                    if (onAnyBorder || inAnyFill)
                        patternColor = lerp(patternColor, colBG, 1.0 - _ShapeOpacity);
                }
