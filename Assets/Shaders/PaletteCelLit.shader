            ...
            half4 Frag(Varyings IN) : SV_Target
            {
                ...
                #if defined(_CLUSTER_LIGHT_LOOP) || defined(_ADDITIONAL_LIGHTS)
                {
                    ...
                    LIGHT_LOOP_BEGIN(GetAdditionalLightsCount())
                        ...
                        // Gate por luminancia real — un point/spot light con intensidad 0
                        // no debe empujar lightValue vía _RollgeonLightData (preQuantizeIntensity
                        // es un boost artístico fijo, no depende de la intensidad real de la luz).
